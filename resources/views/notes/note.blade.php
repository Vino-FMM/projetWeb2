...
@section('content')
    <main>
        <div class="header">
            <h4>Notes</h4> 
            <a href="{{ route('home') }}" class="back">retour</a>
        </div> 
...
<footer>
    ...
    <div>
        <a href="{{ route('Ajouter-bouteilles', ['cellier_id' => 0]) }}"><img src="https://s2.svgbox.net/octicons.svg?ic=search&color=000" width="22" height="22"></a>
        <span>Recherche</span>
    </div>
</footer>
